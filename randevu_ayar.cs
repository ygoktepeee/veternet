...
namespace Veternet
{
    public partial class randevu_ayar : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'veternetDataSet6.pet_save' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.pet_saveTableAdapter3.Fill(this.veternetDataSet6.pet_save);
            // TODO: Bu kod satırı 'veternetDataSet5.pet_save' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.pet_saveTableAdapter2.Fill(this.veternetDataSet5.pet_save);
            // TODO: Bu kod satırı 'veternetDataSet4.pet_save' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.pet_saveTableAdapter1.Fill(this.veternetDataSet4.pet_save);
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            pictureBox1.ImageLocation = dataGridView1.Rows[choose].Cells[11].Value.ToString();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            this.pet_saveTableAdapter.Fill(this.veternetDataSet3.pet_save);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            commandinsert.Parameters.AddWithValue("@i6", textBox3.Text);
        ...
        {
            connection.Open();
            SqlCommand commandupdate = new SqlCommand("Update pet_save Set pet_name=@u1,pet_sex=@u2,pet_race=@u3,birth_date=@u4,weight=@u5,province=@u6,district=@u7,customer_name=@u8,customer_surname=@u9,image=@u10 where id=@u11", connection);

...
namespace Veternet
{
    public partial class randevu_ayar : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'veternetDataSet9.province' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.provinceTableAdapter.Fill(this.veternetDataSet9.province);
        ...
        {
            this.pet_saveTableAdapter.Fill(this.veternetDataSet8.pet_save);
